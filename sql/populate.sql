...
VALUES
(6000, '2001 4runner', 'ODO 240,000, excellent condition', CURRENT_DATE, '2018-07-01', 'active', 'autos', 1, 'nh'),
(9000, '1976 280z', 'ODO ~160,000 runs and drives, good condition', CURRENT_DATE, '2018-07-10', 'active', 'autos', 2, 'nh'),
(13500, 'Altima', '2013, excellent condition', CURRENT_DATE, '2018-06-21', 'active', 'autos', 3, 'nh'),
(16500, 'Red Pilot', '2011, excellent condition, like new', CURRENT_DATE, '2018-06-22', 'active', 'autos', 4, 'nh'),
(25000, 'RAM truck', '2016 new', CURRENT_DATE, '2018-06-27', 'active', 'autos', 5, 'nh'),
(30, '2st Ed. The Cat in the Hat', 'Rare and 1 of 200', CURRENT_DATE, '2018-08-02', 'active', 'books', 6, 'dl'),
(35, '3st Ed. Green Eggs and Ham', 'Rare and 1 of 300', CURRENT_DATE, '2018-08-03', 'active', 'books', 7, 'dl'),
(45, '1st Ed. How the Grinch Stole Christmas', 'Rare and 1 of 100', CURRENT_DATE, '2018-08-05', 'active', 'books', 8, 'dl'),
(25, '1st Ed. Fox in Sock', 'Rare and 1 of 100', CURRENT_DATE, '2018-08-01', 'active', 'books', 9, 'dl'),
(40, '2st Ed. The Lorax', 'Rare and 1 of 200', CURRENT_DATE, '2018-08-04', 'active', 'books', 10, 'dl'),
(25, 'GTA V on VHS', 'RIP', CURRENT_DATE, '2018-10-01', 'active', 'video games', 11, 'js'),
(45, 'Legend of Zelda on VHS', 'RIP', CURRENT_DATE, '2018-10-02', 'active', 'video games', 12, 'js'),
(40, 'Super Mario on VHS', 'RIP', CURRENT_DATE, '2018-10-03', 'active', 'video games', 13, 'js'),
(2500, 'Minecraft on VHS', 'RIP', CURRENT_DATE, '2018-10-04', 'active', 'video games', 14, 'js'),
(15, 'Cuphead on VHS', 'RIP', CURRENT_DATE, '2018-10-05', 'active', 'video games', 15, 'js'),
(900, 'Jordan 1 Retro High Off-White', 'hypebeast filth', CURRENT_DATE, '2018-09-01', 'active', 'shoes', 16, 'pm'),
(400, 'Yeezy 500 Blush', 'Kanye 2020', CURRENT_DATE, '2018-09-02', 'active', 'shoes', 17, 'pm'),
(200, 'Thunder Spectra Black', 'New never worn', CURRENT_DATE, '2018-09-03', 'active', 'shoes', 18, 'pm'),
(300, 'Titan II Extra Butter', 'Issa shoe', CURRENT_DATE, '2018-09-04', 'active', 'shoes', 19, 'pm'),
(60, 'Blakc Chuck Taylor', 'pleb shoes', CURRENT_DATE, '2018-09-05', 'active', 'shoes', 20, 'pm');
